package main.darkhorse.com.getsportyassisment.pieChart.renderer.scatter;
...
public class TriangleShapeRenderer implements IShapeRenderer
{
    ...
    @Override
    public void renderShape(Canvas c, IScatterDataSet
            dataSet, ViewPortHandler viewPortHandler,
