...
public class TabFragment_education extends Fragment implements View.OnClickListener, ApiData {
    ...
    View rootView;
    String jsonData;
    ImageView edit_sports_education_text, edit_formal_education, edit_other;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.tab_education, container, false);
