...
public class AmDashboardActivity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_am_dashboard);
        ...
        navigationView.setNavigationItemSelectedListener(AmDashboardActivity.this);
    ...
    public void onClick(View view)
    {
        ...
        switch (id)
        {
            case R.id.institution_cardView:
                ...
                Intent activitylist = new Intent(AmDashboardActivity.this, AssessmentEventList.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intentAbout = new Intent(AmDashboardActivity.this, AboutActivity.class);
            startActivity(intentAbout);

        } else if (id == R.id.nav_contact) {
            Intent intentAbout = new Intent(AmDashboardActivity.this, ActivityContactUs.class);
            startActivity(intentAbout);
            ...
            Intent main = new Intent(AmDashboardActivity.this, ActivityLoginAdmin.class);
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            final AlertDialog.Builder alertDialog = new AlertDialog.Builder(AmDashboardActivity.this, R.style.MyDialogTheme);
