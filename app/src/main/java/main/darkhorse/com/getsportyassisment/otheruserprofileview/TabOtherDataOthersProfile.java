...
public class TabOtherDataOthersProfile extends Fragment implements View.OnClickListener, OtherProfileInterface {
    ...
    public TabOtherDataOthersProfile() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_tab_other_data_others_profile, container, false);
...
//
    ...
    public void getOthersData(String dob, String gender, String prof_name, String sport, String link, String age_group_coached, String languages_known, String userid) {
        ...
        if (prof_name != null)
            ...
            profession.setText("Add profession");

        if (dob != null)
            this.dob.setText(dob);
        else
            this.dob.setText("Enter dob");


        if (sport != null)
            this.sport.setText(sport);
        else
            this.sport.setText("Add sport");

        if (link != null) {
            linkToPersonalWeb.setText(link);
            linkString = link;
        } else {
            linkToPersonalWeb.setText("Add link");
            linkString = "";
        }
        if (age_group_coached != null) {
            ...
            ageGroup.setText("Add age group");
            ageGrpString = "";
        ...
        if (languages_known != null) {
            ...
            langKnown.setText("Add languages");
            langString = "";
    ...
    void afterresponse(String response)
    {
        ...
        try {
            ...
            if (status.equals("1")) {
                Toast.makeText(getContext(), R.string.data_update, Toast.LENGTH_LONG).show();


            } else {
                Toast.makeText(getContext(), R.string.server_not_response, Toast.LENGTH_LONG).show();
